...
setup(
    name='py-to-exe',
    version=version,
    url='https://github.com/danbenba/py-to-exe',
    license='MIT',
    author='Brent Vollebregt',
    author_email='contact.danbenba@gmail.com',
    description='Convertit .py en .exe',
    long_description=''.join(open('LISEZMOI.md', encoding='utf-8').readlines()),
